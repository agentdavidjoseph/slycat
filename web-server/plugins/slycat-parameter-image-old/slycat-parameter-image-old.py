...
def register_slycat_plugin(context):
  ...
  """
    ...
    """
        ...
        if did:
            for model in models:
                if "project_data" in model and model["model-type"] == "parameter-image-old" \
    ...
    context.register_model("parameter-image-old", finish)

    # Register custom commands for use by wizards.
    context.register_model_command("GET", "parameter-image-old", "media-columns", media_columns)
    context.register_model_command("GET", "parameter-image-old", "delete-table", delete_table)
    context.register_model_command("POST", "parameter-image-old", "update-table", update_table)

    # Register custom wizards for creating PI models.
    context.register_wizard("parameter-image-old", "New Parameter Space Old Model",
